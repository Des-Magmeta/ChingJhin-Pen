...
我们希望能够制作出一个类似于思源黑体、思源宋体那样的大字符集和字形整合兼备的字体，为此星羽笔楷诞生了。

星羽笔楷是一套 TrueType 泛中日韩字体，支持四种不同的东亚语言（简体中文、繁体中文、日文和韩文），7 种粗细类型中的每一种都有约 5 万个字形，可共同呈现一致的视觉美感。该字体还包含多个西文字形，支持拉丁语、希腊语和西里尔文脚本，这些字形一部分来源于 Klee One，一部分来源于霞鹜文楷。
